<template>
  <div>
    ...
    />
    <error-wrong-code
      v-if="modal === 'incorrect_code'"
      :message="`Введений код неправильний. <br />Будь-ласка, перевір
              <br />акційний код.`"
      @close="$store.commit('MODAL_SET', null)"
    />
    <error-wrong-code
      v-if="modal === 'wrong_code'"
      :message="`Такого коду не існує. <br />Будь-ласка, введи коректний
              <br />акційний код.`"
      @close="$store.commit('MODAL_SET', null)"
    />
    <rules-modal
